...
class Chatbot extends Component {
                ...
                <div className="card-panel grey lighten-5 z-depth-1">
                    <div style={{overflow: 'hidden'}}>
                        <div className="col s2">
                            <a href="/" className="btn-floating btn-small waves-effect waves-light red">{message.speaks}</a>
                        </div>
    ...
    render() {
        if (this.state.showBot) {
            return (
                <div style={{ minHeight: 400, maxHeight: 400, width:350, position: 'absolute', bottom: 0, right: 0, border: '1px solid lightgray'}}>
                    <nav>
                ...
                <div id="chatbot"  style={{ minHeight: 288, maxHeight: 288, width:'100%', overflow: 'auto'}}>
        ...
        return (
            <div style={{ minHeight: 40, maxHeight: 400, width:350, position: 'absolute', bottom: 0, right: 0, border: '1px solid lightgray'}}>
                <nav>
                    <div className="nav-wrapper">
                        <a href="/" className="brand-logo">ChatBot</a>
                        <ul id="nav-mobile" className="right hide-on-med-and-down">
